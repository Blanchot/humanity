# 16_servo_1.py (for rebuilt submarine work using 'prometheus')
# USAGE: (sudo) python3 -i 16_servo_1.py
# using ABElectronics Servo Pi pwm controller
# based on ABElectronics PWM servo controller demo
# 11.09.2024 started adding new code
...
fig5_L = [250, 188, 115, 63, 0] #fig 5 left arm
fig5_R = [0, 63, 113, 188, 250] #fig 5 right arm
fig6_L = [250, 170, 100, 55, 0] #fig 6 left arm
fig6_R = [0, 63, 120, 188, 250] #fig 6 right arm
fig7_L = [250, 180, 115, 60, 0] #fig 7 left arm
fig7_R = [0, 50, 105, 180, 250] #fig 7 right arm
fig8_L = [250, 188, 115, 52, 0] #fig 8 left arm
fig8_R = [0, 55, 110, 188, 250] #fig 8 right arm
